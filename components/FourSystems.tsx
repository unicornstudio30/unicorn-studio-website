      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-10 sm:mb-12 lg:mb-14">
          ...
          <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto leading-[1.6] px-4">
            One flagship, four supporting systems. Pick the one that hurts most, or let us map your business on the discovery call and recommend the order.
          </p>
        </div>
        ...
        {/* Four supporting systems as a 2x2 grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-7 lg:gap-8">
          {rest.map((sys) => (
            <Link
              key={sys.number}
              href={sys.href}
              className="group relative bg-white rounded-2xl border border-gray-200 hover:border-blue-300 transition-all duration-300 p-7 sm:p-8 lg:p-9 overflow-hidden flex flex-col h-full shadow-sm hover:shadow-[0_25px_60px_-15px_rgba(59,130,246,0.25)]"
            >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mt-10 sm:mt-12 lg:mt-14">
          ...
          >
            <span className="relative z-10">Tell us which system you need</span>
